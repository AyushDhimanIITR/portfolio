        ...
        <Layout className='pt-0 md:p-16 sm:p-8'>
          <div className='flex items-center justify-between w-full lg:flex-col '>
            <div className='w-1/2 md:w-full'>
              <Image src={profilePic} alt="" className="h-auto w-full lg:hidden md:inline-block md:w-full" priority
            ...
            <div className='w-1/2 flex flex-col items-center self-center lg:w-full lg:text-center '>
              <AnimatedText text="Developing Apps that capture Users!" className='!text-6xl !text-left 
              ...
              <div className='flex items-center self-start mt-2 lg:self-center'>
                <Link href="/dummy.pdf" target={"_blank"}
                  className='flex items-center bg-dark text-light p-2.5 px-6 rounded-lg font-semibold text-lg hover:bg-light hover:text-dark
                ...
                <Link className='ml-4 text-lg font-medium capitalize text-dark underline dark:text-light md:text-base'
                  href="mailto:ayushd175@gmail.com" target={"_blank"}>Contact</Link>
              </div>
            </div>
          </div>
        </Layout>
